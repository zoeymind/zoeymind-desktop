...
import { ProjectProvider } from "@/products/mind/features/mindmap/contexts/ProjectContextProvider"
...
export function WorkspaceShell() {
  ...
  // Cold-start a persisted editor behind the global loading surface. The hook
  // captures the initial tab, so normal keep-alive tab switches never replay it.
  useInitialWorkspaceLoading(activeId)
