// GENERATED from tweakcn official presets (github.com/jnsahaj/tweakcn). Do not edit by hand.
export const THEME_PRESET_STORAGE_KEY = 'zoey-theme-preset'
...
export interface ThemePreset {
  id: string
  label: string
  styles: { light: ThemeStyleProps; dark: ThemeStyleProps }
  /** Light-mode preview swatches: [background, primary, accent]. */
...
export const THEME_PRESETS: ThemePreset[] = [
  {
    ...
    preview: ['hsl(0 0% 100%)', 'hsl(0 0% 9%)', 'hsl(0 0% 92%)']
  },
  {
    id: 'modern-minimal',
  ...
  },
  {
    ...
    preview: ['oklch(0.99 0 0)', 'oklch(0 0 0)', 'oklch(0.94 0 0)']
  },
  {
    id: 'darkmatter',
    label: 'Darkmatter',
