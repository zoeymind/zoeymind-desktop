...
/**
 * Styled emoji picker (Frimousse + 主题 token)。
 * 典型用法：套在 Popover 里，Root 的 onEmojiSelect={({emoji}) => ...} 拿到选中表情。
 *   <EmojiPicker onEmojiSelect={...}><EmojiPickerSearch /><EmojiPickerContent /></EmojiPicker>
 */
