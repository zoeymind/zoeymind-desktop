...
export const initRootNodePositionMap: Record<string, number> = {
...
export const cssContent: string = `
  ...
  /* WKWebView may start native text selection while dragging SVG content. */
  .smm-mind-map-container {
    -webkit-user-select: none;
    user-select: none;
  }
  /* Text editing remains selectable when customInnerElsAppendTo places it inside the canvas. */
  .smm-mind-map-container .smm-node-edit-wrap {
...
// 非富文本模式下的节点文本行高
export const noneRichTextNodeLineHeight: number = 1.2;
// 富文本支持的样式列表
