...
let extended = false
interface QuillBlotConstructor {
  new (...args: unknown[]): object
  create(value: unknown): HTMLElement
}
const QuillFormula = Quill.import('formats/formula') as unknown as QuillBlotConstructor
...
class Formula {
  ...
  constructor(opt) {
    ...
    ;(window as { katex: typeof katex }).katex = katex
    this.init()
